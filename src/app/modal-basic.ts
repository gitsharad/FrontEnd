...
export class NgbdModalBasic {
  ...
  comparator(value){
    ...
    console.log('l',newArray,value,this.cartProduct.styleGuide.tones)
   if(newArray){
     return true
    } else {
     return  false
  ...
  addAudience(value:string) {
    this.cartProduct.styleGuide.audiences.push(value)
  }

  addIndustry(value:string){
    this.cartProduct.styleGuide.industries.push(value)
  }

  addTone(value:string){
    this.cartProduct.styleGuide.tones.push(value)
  }
  ...
  removeAudience(index){
    this.cartProduct.styleGuide.audiences.splice(index,1)
  }

  removeTone(index){
    this.cartProduct.styleGuide.tones.splice(index,1)
  }

  removeIndustry(index){
    this.cartProduct.styleGuide.industries.splice(index,1)
  }
